        ...
        <header className="top-0 z-50 w-full border-b-base-300 border-b-2 flex justify-center">
          <div className="flex items-center justify-between w-full px-3 py-3 max-w-10/12">
            ...
            <div className="flex items-center">
              ...
              <a href="https://linkedin.com/in/asrarabbasi" data-tip="LinkedIn" className="tooltip tooltip-bottom hidden sm:inline-flex items-center justify-center text-gray-500 w-10 h-10 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-none focus:ring-1 focus:ring-gray-200 dark:focus:ring-gray-700 rounded-lg text-sm p-2.5 mr-1">
              ...
              <a href="https://www.youtube.com/@azrar" data-tip="YouTube" className="tooltip tooltip-bottom hidden sm:inline-flex items-center justify-center text-gray-500 w-10 h-10 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-none focus:ring-1 focus:ring-gray-200 dark:focus:ring-gray-700 rounded-lg text-sm p-2.5 mr-1">
              ...
              <a href="https://twitter.com/asrar_ca" data-tip="X / Twitter" className="tooltip tooltip-bottom hidden sm:inline-flex items-center justify-center text-gray-500 w-10 h-10 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-none focus:ring-1 focus:ring-gray-200 dark:focus:ring-gray-700 rounded-lg text-sm p-2.5 mr-1">
