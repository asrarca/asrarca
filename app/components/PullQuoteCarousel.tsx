...
export default function PullQuoteCarousel({ pullQuotes, fontClassName }: PullQuoteCarouselProps) {
  ...
  return (
    <section className="flex justify-center py-16 px-6 bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-800 dark:to-gray-900">
      <div className="max-w-4xl w-full text-center">
        <div className="relative overflow-hidden">
          <svg className="absolute -top-4 left-0 w-12 h-12 text-gray-300 dark:text-gray-600 opacity-50" fill="currentColor" viewBox="0 0 32 32">
          ...
          >
            ...
            <cite className="text-lg md:text-xl text-gray-700 dark:text-gray-400 not-italic">
              — {currentQuote.name}
              <div className="text-md text-gray-500 dark:text-gray-500">{currentQuote.position}</div>
            </cite>
          </div>

          <svg className="absolute -bottom-4 right-0 w-12 h-12 text-gray-300 dark:text-gray-600 opacity-50 rotate-180" fill="currentColor" viewBox="0 0 32 32">
            <path d="M10 8c-3.3 0-6 2.7-6 6v10h8V14h-4c0-2.2 1.8-4 4-4V8zm14 0c-3.3 0-6 2.7-6 6v10h8V14h-4c0-2.2 1.8-4 4-4V8z"/>
          </svg>
        </div>
